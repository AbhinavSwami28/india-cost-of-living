...
export default function CitySelector({ city1Slug, city2Slug }: CitySelectorProps) {
  ...
  const [c1, setC1] = useState(city1Slug || "");
  const [c2, setC2] = useState(city2Slug || "");
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
      <h2 className="text-lg font-bold text-gray-900 mb-4">Compare Two Cities</h2>
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-end gap-4">
        ...
        <button
          ...
          className="bg-orange-500 hover:bg-orange-600 disabled:bg-gray-300 disabled:cursor-not-allowed text-white px-6 py-2.5 rounded-lg text-sm font-semibold transition-colors"
        >
          Compare
        </button>
      </div>
